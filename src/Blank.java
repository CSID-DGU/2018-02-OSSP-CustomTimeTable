...
public class Blank extends JFrame {
	...
	public Blank(CourseList _layer) {
...
{
	CourseList mFrame = null;
	Blank bFrame = null;
	
	public inputBlankHandler(CourseList _layer, Blank _bframe)
	{
		mFrame = _layer;
		bFrame = _bframe;
	}
...
class AllPressEvent implements ActionListener
{
	JButton btn = null;
	Blank frame = null;
	public AllPressEvent(Blank _frm, JButton _btn)
	{
		frame= _frm;
		btn = _btn;
	}
...
class PressEvent implements ActionListener
{
	...
	JButton btn2 = null;
	Blank frame = null;
	public PressEvent(JButton _btn, JButton _btn2, Blank _frame)
	{
		btn= _btn;
		btn2= _btn2;
		frame = _frame;
...
{
	Blank frame = null;
	public BlankAddEventHandler(Blank _bframe)
	{
		frame = _bframe;
	}
...
{
	Blank bFrame = null;
	public BlankRemoveEventHandler(Blank _bframe)
	{
		bFrame = _bframe;
	}
